...
This template outlines system boundaries, module layout, data flow, and a high
level threat model for Starisian WordPress plugins.
...
Requests enter through WordPress hooks, are routed through the core singleton,
and fan out to feature modules. External API calls must be sanitized and escaped.
